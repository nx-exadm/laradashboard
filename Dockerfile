...
# ==============================================================================
# ENABLE CUSTOMFORM MODULE
#
# Starter26 and Forum are assumed already enabled in modules_statuses.json
# committed to the repo. CustomForm is new, so we explicitly enable it here
# on every boot -- this is idempotent and safe to run repeatedly.
# ==============================================================================

echo ""
echo "=================================================="
echo "ENABLING CUSTOMFORM MODULE"
echo "=================================================="
